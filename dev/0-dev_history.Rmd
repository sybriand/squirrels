...
fusen::fill_description(
  ...
  fields = list(
    ...
    Description = "Data analysis of squirrels data frame",
    `Authors@R` = c(
      person("Steve", "Briand", email = "steve.briand@atih.sante.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Steve Briand")
```
...
# disposition de données demo squirrels
...
readr::read_csv(system.file("nyc_squirrels_sample.csv", package = "squirrels"))
```


# creation du script globals.r
```{r}
